  ...
  return (
    <div className="mt-8 space-y-6 animate-in fade-in duration-500">
            ...
            {data.fees.map((fee, index) => (
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap font-medium text-emerald-700">
                  {fee.totalBs !== null ? fee.totalBs.toLocaleString('es-VE', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : '-'}
                </td>
              </tr>
            ))}
          </tbody>
      ...
      <div className="text-sm text-slate-500 mt-4 space-y-1">
        ...
        <p>* El cálculo incluye el monto mensual ({data.monthFeeTcmmv} TCMMV-BCV) más los gastos de formulario ({data.baseFeeTcmmv} TCMMV-BCV).</p>
      </div>
    </div>
  );
}
